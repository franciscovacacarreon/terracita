        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-lg-12 col-sm-12">
                    ...
                    <div class="form-group row">
                        <label for="descripcion" class="col-sm-4 col-form-label">Tipo item menú:</label>
                        <div class="col-sm-8">
            ...
            <div class="row">
                <div class="col-lg-12 col-sm-12">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input name="nombre-edit" type="text" class="form-control" id="nombre-edit" placeholder="Ej: hollow">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="precio-edit" class="col-sm-4 col-form-label">Precio:</label>
                        <div class="col-sm-8">
                            <input name="precio-edit" type="number" class="form-control" id="precio-edit" placeholder="Ej: 10">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="descripcion-edit" class="col-sm-4 col-form-label">Descripción:</label>
                        <div class="col-sm-8">
                            <input name="descripcion-edit" type="text" class="form-control" id="descripcion-edit" placeholder="Ej: especial">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="id_tipo_menu-edit" class="col-sm-4 col-form-label">Tipo item menú:</label>
                        <div class="col-sm-8">
                           <select name="id_tipo_menu-edit" id="id_tipo_menu-edit" class="form-control">
                                <option value="0">Selecciona una opción</option>
                           </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="imagen-edit" accept="image/*" onchange="mostrarVistaPrevia()">
